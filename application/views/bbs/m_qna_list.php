					...
					<ul class="board-list">
						<li class="head">
							...
							<div class="list-info">
								...
								<p class="date">작성일</p>
								<p class="reply">답변여부</p>
							</div>
						</li>
						<? foreach ($notice_list as $nl){ ?>
						<li onclick="location.href='board_view.php';">
							<p class="num">10</p>
							<p class="type">공지</p>
							<p class="tit"><a href="board_view.php">제목이 들어갑니다.</a></p>
							<div class="list-info">
								<p class="writer">운영자</p>
						...
						<li onclick="location.href='<?=$url?>';">
							...
							<div class="list-info">
								...
								<p class="reply"><? if($lt->coment_cnt) {?><span class="end">답변완료</span><?}else{?><span class="wait">답변대기중</span><?}?></p>
							</div>
						</li>
						<? 
							$listNo--;
